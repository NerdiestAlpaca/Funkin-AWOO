...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...initSonglist.length)
		{
			...
			if (FileSystem.exists('assets/data/${format}/${format}-rematch.json'))
				diffsThatExist.push("Rematch");
			...
			#else
			diffsThatExist = ["Easy","Normal","Hard", "Rematch"];
			#end
			...
			if (diffsThatExist.contains("Rematch"))
