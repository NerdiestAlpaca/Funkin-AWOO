	...
	override public function create()
	{
		...
		switch(songLowercase)
		{
			...
			case 'satellite' | 'our-world' | 'mischief' | 'free-spirit' | 'catnap' | 'daredevil' | 'dreamboat' | 'primadonna' | 'swerve-on':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/$songLowercase/coolswag'));
		}
         ...
         switch (SONG.player2)
           {
			 ...
			 case 'savannah':
			 healthBar.createFilledBar(0xFF403898, 0xFF0097C4);
			 case 'quincy':
			 healthBar.createFilledBar(0xFFD57341, 0xFF0097C4);
			 case 'petula':
			 healthBar.createFilledBar(0xFFD792FF, 0xFF0097C4);
			 case 'roxie':
			 healthBar.createFilledBar(0xFFFFCC66, 0xFF0097C4);
			 case 'jade':
			 healthBar.createFilledBar(0xFF359100, 0xFF0097C4);
			 case 'trip':
			 healthBar.createFilledBar(0xFFFF6666, 0xFF0097C4);
			 case 'austin':
			 healthBar.createFilledBar(0xFF669DCC, 0xFF0097C4);
			 case 'edie':
			 healthBar.createFilledBar(0xFF52C565, 0xFF0097C4);
			 case 'bev':
			 healthBar.createFilledBar(0xFF660066, 0xFF0097C4);
            }
        }
        else
